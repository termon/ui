...
<div x-data="{
    ...
    x-on:keydown.shift.tab.prevent="prevFocusable().focus()" x-show="show" {{-- style="display: {{ $show ? 'block' : 'none' }};" --}} class="relative z-10"
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    @if (isset($title))
                        <div
                            {{ $title->attributes->merge(['class' => 'pb-4 mb-4 text-2xl font-bold border-b border-gray-400 dark:border-gray-600']) }}>
                            {{ $title }}
                        </div>
                    @endif
