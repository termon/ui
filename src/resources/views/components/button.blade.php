@props(['variant' => 'blue','label' => null, 'icon' => null])
@php
    $classes = match ($variant) {
        ...
        'ogreen'
            => 'py-1.5 px-4 transition-colors font-medium rounded-lg text-green-600 bg-gray-50   border border-gray-200   hover:bg-green-600  hover:text-white disabled:opacity-50 focus:outline-none focus:ring-1 focus:ring-green-600 active:bg-gray-200 dark:text-green-400 dark:bg-gray-600 dark:hover:bg-green-500 dark:focus:ring-green-800 dark:border-gray-500 dark:hover:text-white ',
        'oyellow'
            => 'py-1.5 px-4 transition-colors font-medium rounded-lg text-yellow-600 bg-gray-50  border border-gray-200   hover:bg-yellow-600 hover:text-white disabled:opacity-50 focus:outline-none focus:ring-1 focus:ring-yellow-600 active:bg-gray-200 dark:text-yellow-400 dark:bg-gray-600 dark:hover:bg-yellow-500 dark:focus:ring-yellow-800 dark:border-gray-500 dark:hover:text-white ',
        'link'
...
<button {{ $attributes->merge(['class' => $classes])->class(['inline-flex items-center md:gap-1' => isset($icon)]) }}>
    @isset($icon)
