        ...
        <template x-for="(tab, index) in tabHeadings" :key="index">
            <button x-text="tab" @click="switchTab(tab);"
                :class="tab === activeTab ?
                    ...
                    'text-neutral-600 font-medium dark:text-neutral-300 dark:hover:border-b-neutral-300 dark:hover:text-white hover:border-b-2 hover:border-b-neutral-300 hover:text-neutral-900'"
